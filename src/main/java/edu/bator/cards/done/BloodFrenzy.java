...
public class BloodFrenzy extends Attachment {
  ...
  public boolean ableToApplyAbilityTo(Card card, GameState gameState) {
    ...
    boolean enemy =
        gameState.getEnemyHand().contains(this) && card.equals(gameState.getEnemyHero());
  ...
  public void gamePhaseChangeEvent(GameState gameState) {
    ...
    if (GamePhase.YOU_PREPARE.equals(gameState.getGamePhase()) && yourHero.getAttachments()
        .contains(this)) {
    ...
    if (GamePhase.ENEMY_PREPARE.equals(gameState.getGamePhase()) && enemyHero.getAttachments()
        .contains(this)) {
