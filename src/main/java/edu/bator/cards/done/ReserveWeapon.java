...
public class ReserveWeapon extends Artifact {
  ...
  private void paintUi(GameState gameState, Stage dialog, GridPane cardsGrid) {
    ...
    graveyard
        ...
        .forEach(card -> {
          EventHandler<MouseEvent> reserveWeaponClickedEvent = new ReserveWeaponClickedEvent(
              gameState, card, dialog, this);
          CardUiHelper.paintCardOnDialogGridPane(gameState, cardsGrid, index, card,
              reserveWeaponClickedEvent);
        });
  ...
  public static class ReserveWeaponClickedEvent implements EventHandler<MouseEvent> {
